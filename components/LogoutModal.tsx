    ...
    >
      <div className="bg-[#020d0c] rounded-[40px] w-full max-w-sm shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden border border-white/5 animate-in zoom-in duration-300">
        ...
        <div className="flex h-20 border-t border-white/5">
          <button
            onClick={onClose}
            className="flex-1 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 hover:text-white hover:bg-white/5 transition-all outline-none"
          >
            Cancelar
          </button>
          <button
            onClick={onConfirm}
            className="flex-1 bg-primary text-dark text-[10px] font-black uppercase tracking-[0.2em] hover:bg-white transition-all active:scale-95 flex items-center justify-center space-x-2 shadow-[0_0_30px_rgba(0,184,169,0.3)] outline-none"
          >
            <LogOut size={16} />
